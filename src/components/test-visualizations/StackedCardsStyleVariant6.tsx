...
// Variant 6: Elegant - Thin border, sophisticated
export default function StackedCardsStyleVariant6({ deck }: StackedCardsStyleProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="text-center mb-4">
        <h3 className="text-lg font-bold text-gray-800">Variant 6: Green/Mint</h3>
        ...
        <div className="relative" onDoubleClick={handleDoubleClick}>
          ...
          <div className="flex gap-3 overflow-x-auto md:overflow-hidden scrollbar-hide">
            {currentSection.cards.map((card) => (
              <div
                key={card.id}
                className="flex-shrink-0 bg-gradient-to-br from-green-50 to-teal-50 border-2 border-green-200 rounded-2xl p-4 shadow-lg transition-all duration-300"
                style={{
            ...
            {sectionCards
              ...
              .map((card, stackIndex) => {
                ...
                return (
                  <div
                    key={card.id}
                    className="absolute bg-gradient-to-br from-green-50 to-teal-50 border-2 border-green-200 rounded-2xl p-4 shadow-lg cursor-pointer transition-all duration-300"
                    style={{
                      left: `${stackOffset}px`,
                      top: `${stackOffset}px`,
